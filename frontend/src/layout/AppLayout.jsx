...
function AppLayout({ setIsLoggedIn }) {
  ...
  // Load initial data from API when the layout mounts
  // This ensures the store is populated once the user is logged in
  ...
  useEffect(() => {
    ...
    async function initData() {
      ...
      try {
          ...
          // keep failing silently; components will handle empty states
